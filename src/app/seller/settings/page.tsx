...
export default function SellerSettingsPage() {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center border border-slate-200 dark:border-slate-800 bg-white/60 dark:bg-slate-950/60 rounded-3xl p-8 backdrop-blur-md">
      ...
      <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200">Store Settings</h2>
      <p className="text-sm text-slate-500 mt-2 max-w-sm">
        Modify your store description, upload logo and banners, change payout bank details and update contact information.
      </p>
