...
export default function SellerAnalyticsPage() {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center border border-slate-200 dark:border-slate-800 bg-white/60 dark:bg-slate-950/60 rounded-3xl p-8 backdrop-blur-md">
      ...
      <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200">Analytics & Reports</h2>
      <p className="text-sm text-slate-500 mt-2 max-w-sm">
        Track sales performance graphs, best selling categories, monthly payout statements, and commission details.
      </p>
